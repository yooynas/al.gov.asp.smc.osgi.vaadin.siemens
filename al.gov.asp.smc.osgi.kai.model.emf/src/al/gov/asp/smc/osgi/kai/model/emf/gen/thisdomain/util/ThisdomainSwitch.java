 ...
 * $Id$
 */
package al.gov.asp.smc.osgi.kai.model.emf.gen.thisdomain.util;
 ...
 * @generated
 */
public class ThisdomainSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ThisdomainPackage modelPackage;
	 ...
	 * @generated
	 */
	public ThisdomainSwitch() {
		if (modelPackage == null) {
			modelPackage = ThisdomainPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ThisdomainPackage.PERSON: {
				Person person = (Person)theEObject;
				T result = casePerson(person);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ThisdomainPackage.COMPANY: {
